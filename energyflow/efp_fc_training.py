...
# read forward/central data from dat file
from fc_inputs import load_fc_data
...
X = efpset.batch_compute(masked_X) #batch_compute -> compute
print('Done')
...
if plt:
    ...
    # axes labels
    plt.xlabel('Forward Jet Efficiency')
    plt.ylabel('Central Jet Rejection')
